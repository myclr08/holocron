...
Güncel sürüm: **v0.12.2** (bkz. [Sürüm notları](#sürüm-notları)).
...
| --- | --- | --- |
| **v0.12.2** | 20 Eylül 2026 | Saha geri bildirimi: alan geçmişi **popover'ı** artık "şunda şu oldu" ok kalıbı yerine kronolojik bloklar gösteriyor (**eskiden yeniye**). Her girdi kendi bloğunda: üstte tarih/saat, altında değerin kendisi (`white-space: pre-wrap`, uzun metin kesilmez); ilk girdi **"ilk değer"** etiketiyle, son (güncel) girdi hafif vurguyla işaretlenir, boş değer **"— (boş)"** olarak gösterilir. Popover genişliği içeriğe göre ~360–560px arasında esner, uzun listelerde popover içinde dikey kaydırma olur (sayfa taşmaz). 20 ve üzeri girdide en eski değişiklikler **"… önceki N değişikliği göster"** bağlantısının arkasına katlanır. Kayıt çekmecesindeki satır içi alan geçmişi (ok kalıbı) değişmedi |
| **v0.12.1** | 20 Eylül 2026 | Saha geri bildirimi: Ayarlar'daki **Geri** düğmesi artık her zaman ilk filoya değil, ana ekranda **son bakılan yere** dönüyor. Ana ekranın görünümü (seçili filo, Görevlerim, Sefer) adres çubuğunda hash olarak tutuluyor (`#filo/<id>`, `#gorevlerim`, `#sefer`) ve yedek olarak `localStorage`'a da yazılıyor; açılışta önce hash'e, o yoksa `localStorage`'daki son görünüme, o da yoksa ilk filoya gidiliyor. Ayarlar'daki Geri artık düğme: `document.referrer` ana sayfaya aitse `history.back()` çalışır, değilse ana sayfa son görünüm hash'iyle açılır; tarayıcının kendi geri tuşu da hash tabanlı olduğu için doğal olarak aynı yere düşer |
